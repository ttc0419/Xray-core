...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"\bsettings\x18\x02 \x01(\v2 .xray.common.serial.TypedMessageR\bsettings\"\xce\x03\n" +
	"\fStreamConfig\x125\n" +
	...
	"\x0fsocket_settings\x18\x06 \x01(\v2%.xray.transport.internet.SocketConfigR\x0esocketSettingsJ\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fJ\x04\b\f\x10\rR\budpmasksR\btcpmasksR\vquic_params\"\x93\x01\n" +
...
var file_transport_internet_config_proto_goTypes = []any{
	...
	(*HappyEyeballsConfig)(nil),  // 7: xray.transport.internet.HappyEyeballsConfig
...
var file_transport_internet_config_proto_depIdxs = []int32{
	...
	7,  // 9: xray.transport.internet.SocketConfig.happy_eyeballs:type_name -> xray.transport.internet.HappyEyeballsConfig
